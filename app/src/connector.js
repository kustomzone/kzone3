'use strict';
  ...
  Connector = (function(_super) {
	...
	function Connector(client, scene, physicsWorld, uri, isPortal, referrer) {
	  ...
	  if (this.client.authentication.isLoggedIn()) { this.authenticate(); }
	...
	Connector.prototype.webRTC = function() {
	  ...
	  $('body').keydown((function(self) {
		return function(e) {
		  if (e.keyCode === 84) { return self.startTalking(); }
		};
	  })(this));
	  
	  $('body').keyup((function(self) {
		return function(e) {
		  if (e.keyCode === 84) { return self.stopTalking(); }
		};
	  })(this));
	...
	Connector.prototype.addFloor = function() {
	  ...
	  floorTexture = new THREE.ImageUtils.loadTexture('/img/paving.png');
	...
	Connector.prototype.isPortalOpen = function() { return !!this.portal; };
