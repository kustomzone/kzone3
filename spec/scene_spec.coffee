...
Script = require('../js/objects/script')
Box = require('../js/objects/box')
Spawn = require('../js/objects/spawn')
Model = require('../js/objects/model')
Link = require('../js/objects/link')
Skybox = require('../js/objects/skybox')
Fog = require('../js/objects/fog')
Audio = require('../js/objects/audio')
